...
const SideMenu: React.SFC<ISideMenuProps> = (props) => {
    const { collapsed, role } = props;
    const style = collapsed ? { left: '80px' } : { left: '68px' };
    ...
    return (
        <>
            ...
            <Menu theme="dark" defaultSelectedKeys={['1']} mode="inline">
                ...
                {role === 'investor' && (
                    <Menu.SubMenu key='investment' title={
                        <span>
                            <Icon type='dollar' />
                        ...
                        <Menu.Item key="profile">
                            <Link to={`/dash/${role}/applies`}>
                                My Investments
                            </Link>
                        </Menu.Item>
                        <Menu.Item key="offers">
                            <Link to={`/dash/${role}/offers`}>
                                Offers
                            </Link>
                        </Menu.Item>
                    </Menu.SubMenu>
