    ...
    return (
      <>
        <section id="top" className="top-menu">
          <Paragraph className={"legal-image-title legal-terms"} />
        </section>
            ...
            <Row>
              <Col>
                ...
                <section className="policy_list_section">
                  <span className="policy_item_title">AGREEMENT TO TERMS</span>
                  <span className="policy_item_description">
                    ...
                    entity (“you”) and BRITE Investments, Inc., doing business
                    as BRITE ("<strong>BRITE</strong>", “<strong>we</strong>”, “
                    <strong>us</strong>”, or “<strong>our</strong>”), concerning
                    your access to and use of the brite.us website as well as
                    ...
                    services: Crowd Investing Platform (the “Marketplace
                    Offerings”). In order to help make the Site a secure
                    environment for the purchase and sale of Marketplace
                ...
                <section className="policy_list_section">
                  <span className="policy_item_title">USER REGISTRATION</span>
                  <span className="policy_item_description">
                ...
                <section className="policy_list_section">
                  <span className="policy_item_title">REFUNDS POLICY</span>
                  <span className="policy_item_description">
                ...
                <section className="policy_list_section">
                  ...
                  <ul className="policy_ul_bar decimal_list_type">
                    <li className="policy_li_item">
                      <span>
                ...
                <section className="policy_list_section">
                  ...
                  <span className="policy_item_description">
                    ...
                    be viewable by other users of the Site and the Marketplace
                    Offerings and through third-party websites. As such, any
                  ...
                  <ul className="policy_ul_bar decimal_list_type">
                    ...
                    <li className="policy_li_item">
                      <span>
                        Your Contributions do not advocate the violent overthrow
                    ...
                    <li className="policy_li_item">
                      <span>
                        Your Contributions do not violate any federal or state
                ...
                <section className="policy_list_section">
                  ...
                  <span className="policy_item_sub_title">Use License</span>
                  <span className="policy_item_description">
                    ...
                    contained in these Terms of Use. You shall not: (1)
                ...
                <section className="policy_list_section">
                  <span className="policy_item_title">SOCIAL MEDIA</span>
                  <span className="policy_item_description">
                ...
                <section className="policy_list_section">
                  <span className="policy_item_title">SUBMISSIONS</span>
                  <span className="policy_item_description">
                ...
                <section className="policy_list_section">
                  ...
                  <span className="policy_item_description">
                    ...
                    Third-Party Websites or any Third-PartyContent does not
                ...
                <section className="policy_list_section">
                  <span className="policy_item_title">SITE MANAGEMENT</span>
                  <span className="policy_item_description">
                ...
                <section className="policy_list_section">
                  <span className="policy_item_title">PRIVACY POLICY</span>
                  <span className="policy_item_description">
                    ...
                    you access the Site or the Marketplace Offerings from the
                    European Union, Asia, or any other region of the world with
                    ...
                    transferred to and processed in the United States. Further,
                    ...
                    without the requisite and verifiable parental consent, we
                    will delete that information from the Site as quickly as is
                ...
                <section className="policy_list_section">
                  ...
                  <span className="policy_item_description">
                    ...
                    pursuant to federal law you may be held liable for damages
                    if you make material misrepresentations in a Notification.
                    Thus, if you are not sure that material located on or linked
                    to by the Site infringes your copyright, you should consider
                ...
                <section className="policy_list_section">
                  <span className="policy_item_title">GOVERNING LAW</span>
                  <span className="policy_item_description">
                ...
                <section className="policy_list_section">
                  <span className="policy_item_title">DISPUTE RESOLUTION</span>
                  <span className="policy_item_sub_title">
                    Binding Arbitration
                  </span>
                  <span className="policy_item_description">
                    ...
                    arbitration will take place in Osceola County, Florida.
                  ...
                  <span className="policy_item_description">
                    ...
                    the state and federal courts located in Kent County,
                    ...
                    and the the Uniform Computer Information Transaction Act
                  ...
                  <span className="policy_item_sub_title">Restrictions</span>
                  <span className="policy_item_description">
                ...
                <section className="policy_list_section">
                  <span className="policy_item_title">CORRECTIONS</span>
                  <span className="policy_item_description">
                ...
                <section className="policy_list_section">
                  <span className="policy_item_title">DISCLAIMER</span>
                  <span className="policy_item_description">
                ...
                <section className="policy_list_section">
                  <span className="policy_item_title">INDEMNIFICATION</span>
                  <span className="policy_item_description">
                    ...
                    Contributions; (2) use of the Marketplace Offerings; (3)
                    ...
                    Site or the Marketplace Offerings with whom you connected
                ...
                <section className="policy_list_section">
                  <span className="policy_item_title">USER DATA</span>
                  <span className="policy_item_description">
                    We will maintain certain data that you transmit to the Site
                    for the purpose of managing the performance of the
                    Marketplace Offerings, as well as data relating to your use
                    of the Marketplace Offerings. Although we perform regular
                    routine backups of data, you are solely responsible for all
                    data that you transmit or that relates to any activity you
                    have undertaken using the Marketplace Offerings. You agree
                ...
                <section className="policy_list_section">
                  <span className="policy_item_title">MISCELLANEOUS</span>
                  <span className="policy_item_description">
                    These Terms of Use and any policies or operating rules
                    posted by us on the Site or in respect to the Marketplace
