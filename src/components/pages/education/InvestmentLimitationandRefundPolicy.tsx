...
export class InvestmentLimitationandRefundPolicy extends Component<IState> {
  ...
  componentDidMount() {
    ...
    const readmePath = require("./doc/Investment Limitation and Refund Policy.md");
          ...
          >
            ...
            >
              <Tree
                showLine
                defaultExpandedKeys={[
                  "/education/invesetment-limitation-and-refund-policy"
                ]}
