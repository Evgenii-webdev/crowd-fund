...
export class IssuerRegistrationProcess extends Component<IState> {
  ...
  componentDidMount() {
    ...
    const readmePath = require("./doc/Issuer Registration Process.md");
        ...
        <section className="subject center">
          ...
          >
            ...
            >
              <Tree
                showLine
                defaultExpandedKeys={["/education/issuer-registration-process"]}
