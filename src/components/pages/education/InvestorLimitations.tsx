...
export class InvestorLimitations extends Component<IState> {
  ...
  componentDidMount() {
    ...
    const readmePath = require("./doc/Investor Limitations.md");
        ...
        <section className="subject center">
          ...
          >
            ...
            >
              <Tree
                showLine
                defaultExpandedKeys={["/education/investor-limitations"]}
