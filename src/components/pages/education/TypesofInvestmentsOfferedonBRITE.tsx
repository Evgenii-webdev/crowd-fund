...
export class TypesofInvestmentsOfferedonBRITE extends Component<IState> {
  ...
  componentDidMount() {
    ...
    const readmePath = require("./doc/Types of Investments Offered on BRITE.md");
          ...
          >
            ...
            >
              <Tree
                showLine
                defaultExpandedKeys={[
                  "/education/types-of-investments-offered-on-brite"
                ]}
