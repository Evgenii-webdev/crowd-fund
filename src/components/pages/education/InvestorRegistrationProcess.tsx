...
export class InvestorRegistrationProcess extends Component<IState> {
  ...
  componentDidMount() {
    ...
    const readmePath = require("./doc/Investor Registration Process.md");
          ...
          >
            ...
            >
              <Tree
                showLine
                defaultExpandedKeys={[
                  "/education/investor-registration-process"
                ]}
