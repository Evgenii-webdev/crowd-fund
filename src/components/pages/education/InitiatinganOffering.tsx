...
export class InitiatinganOffering extends Component<IState> {
  ...
  componentDidMount() {
    ...
    const readmePath = require("./doc/Initiating an Offering.md");
        ...
        <section className="subject center">
          ...
          >
            ...
            >
              <Tree
                showLine
                defaultExpandedKeys={["/education/initiating-an-offering"]}
