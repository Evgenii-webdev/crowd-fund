...
export class SecuritiesTransferandResaleLimitations extends Component<IState> {
  ...
  componentDidMount() {
    ...
    const readmePath = require("./doc/Securities Transfer and Resale Limitations.md");
          ...
          >
            ...
            >
              <Tree
                showLine
                defaultExpandedKeys={[
                  "/education/securities-transfer-and-resale-limitations"
                ]}
