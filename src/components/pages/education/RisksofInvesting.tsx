...
export class RisksofInvesting extends Component<IState> {
  ...
  componentDidMount() {
    ...
    const readmePath = require("./doc/Risks of Investing.md");
        ...
        <section className="subject center">
          ...
          >
            ...
            >
              <Tree
                showLine
                defaultExpandedKeys={["/education/risks-of-inveseting"]}
